...
def get_robot_xml_path(name):
    resource = files("simulator_for_il_rl.robot") / name
...
class AssemblingEnv(gym.Env):
    ...
    def __init__(
        ...
        self.model = mujoco.MjModel.from_xml_path(get_robot_xml_path(xml_path))
        ...
        self.kinematics = PinKinematics(model_path=get_robot_xml_path("ur10e2f85.xml"), ee_name=self.ee_name)
